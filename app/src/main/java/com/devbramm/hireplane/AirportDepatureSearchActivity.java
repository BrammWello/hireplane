...
public class AirportDepatureSearchActivity extends AppCompatActivity {

    EditText departureTextInput;
    ...
    DepartureCityAdapter departureCityAdapter;

    @Override
    public void onBackPressed() {
        super.onBackPressed();
        AirportDepatureSearchActivity.this.finish();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_airport_depature_search);

        departureTextInput = findViewById(R.id.depart_search_input);

        recyclerView = findViewById(R.id.depart_city_recycler);
        ...
        departureTextInput.addTextChangedListener(new TextWatcher() {
            @Override
            ...
            public void afterTextChanged(Editable s) {
                if (!s.toString().isEmpty()) {
                    ...
                    findViewById(R.id.searching_dept_progress).setVisibility(View.VISIBLE);
                } else {
                    /*
                    ...
                    departureTextInput.clearFocus();
                    recyclerView.setVisibility(View.INVISIBLE);
                    findViewById(R.id.searching_dept_progress).setVisibility(View.INVISIBLE);
                }
            }
        });
    }
...
//                        counter++;
                ...
                departureCityAdapter = new DepartureCityAdapter(AirportDepatureSearchActivity.this, cityNameList, cityIATACodeList, airportNameList);
                recyclerView.setAdapter(departureCityAdapter);
                findViewById(R.id.searching_dept_progress).setVisibility(View.INVISIBLE);
